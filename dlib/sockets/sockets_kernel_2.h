...
// ----------------------------------------------------------------------------------------
    ...
    public:
        ...
        ) const { return info.cast_to<unix_info>().connection_path; }

        bool is_inet (
        ) const { return info.contains<inet_info>(); }
...
// ----------------------------------------------------------------------------------------
    ...
    public:
        ...
        ) const { return info.cast_to<inet_info>().listening_port; }

        const std::string& get_listening_ip (
        ) const { return info.cast_to<inet_info>().listening_ip; }

        const std::string& get_listening_path (
        ) const { return info.cast_to<unix_info>().listening_path; }
